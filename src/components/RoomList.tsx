...
const RoomList: React.FC = () => {
  const { addRoom, updateRoomListOrder } = useActions();
  ...
  const onDragEnd = (result: DropResult) => {
    ...
    const [newOrder] = roomList.splice(source.index, 1);
    roomList.splice(destination.index, 0, newOrder);
    updateRoomListOrder(roomList);
  };
